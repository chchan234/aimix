          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="홍길동"
                className="w-full px-4 py-3 bg-gray-50 dark:bg-[#0d0d0d] border border-gray-300 dark:border-gray-600 rounded-lg text-foreground focus:outline-none focus:border-indigo-500"
              />
            </div>
        ...
        {result?.analysis && (
          <div className="space-y-4 animate-fadeIn">
            <div className="bg-indigo-500/10 rounded-lg p-4 border border-indigo-500/20">
              <h3 className="text-foreground font-semibold mb-3">✏️ 이름 궁합</h3>
              ...
              {result.analysis.strokeAnalysis && (
                <div className="mb-4 pb-4 border-b border-indigo-500/10">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-gray-50 dark:bg-[#0d0d0d] p-3 rounded">
