        ...
        <div className="space-y-6">
          <div className="bg-gray-800 rounded-lg p-6">
            ...
            <div className="space-y-4 text-gray-300">
              ...
              <p className="text-sm text-gray-400 bg-cyan-900/10 p-3 rounded">
            ...
            <div className="bg-cyan-900/20 border border-cyan-500 rounded-lg p-4 mt-6 mb-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-white font-semibold">스트레스 지수 측정</p>
                  <p className="text-gray-400 text-sm">20개의 질문 + AI 분석</p>
                </div>
            ...
            <button
              ...
              className="w-full px-6 py-4 bg-cyan-600 hover:bg-cyan-700 text-white font-semibold rounded-lg transition-colors"
            >
              측정 시작 (25 크레딧)
            </button>
          </div>
      ...
      {step === 'result' && result && (
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-cyan-900 to-blue-900 rounded-lg p-6">
            ...
            <p className="text-gray-300 text-center">{result.analysis.overallAssessment.description}</p>
          ...
          {/* Category Scores */}
          <div className="bg-gray-800 rounded-lg p-6">
            <h3 className="text-xl font-semibold text-white mb-4">영역별 스트레스</h3>
          ...
          {Object.entries(result.analysis.categories).map(([category, data]: [string, any]) => (
            <div key={category} className="bg-gray-800 rounded-lg p-6">
              ...
              <p className="text-gray-300 mb-4">{data.analysis}</p>
          ...
          {/* Management */}
          <div className="bg-gray-800 rounded-lg p-6">
            <h3 className="text-xl font-semibold text-white mb-4">스트레스 관리</h3>
            <div className="space-y-4">
              <div>
          ...
          {/* Resources */}
          <div className="bg-gray-800 rounded-lg p-6">
            <h3 className="text-xl font-semibold text-white mb-4">지원 및 자원</h3>
            <div className="space-y-4 text-gray-300">
