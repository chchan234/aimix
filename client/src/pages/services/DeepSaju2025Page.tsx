      ...
      >
        <div className="space-y-6">
          <div className="bg-gradient-to-r from-purple-500/20 to-indigo-500/20 rounded-xl p-6 border border-purple-500/30">
            <h3 className="text-white text-xl font-bold mb-4">2025 심층 신년운세</h3>
          ...
          <button
            ...
            className="w-full py-4 bg-purple-600 hover:bg-purple-700 text-white font-semibold rounded-lg transition"
          >
            시작하기
          </button>
        </div>
      ...
      <div className="space-y-6">
        {!result && (
          <>
            {/* Birth Date */}
            <div>
              <label className="block text-white font-medium mb-3">생년월일</label>
              <input
                type="date"
                value={birthDate}
                onChange={(e) => setBirthDate(e.target.value)}
                className="w-full p-4 bg-background-dark border border-gray-600 rounded-lg text-white focus:border-purple-500 focus:outline-none"
              />
            </div>

            {/* Birth Time */}
            <div>
              <label className="block text-white font-medium mb-3">태어난 시간 (24시간 형식)</label>
              <input
                type="time"
                value={birthTime}
            ...
            {/* Gender Selection */}
            <div>
              <label className="block text-white font-medium mb-3">성별</label>
            ...
            {activeTab === 'overview' && (
              <div className="space-y-4">
                ...
                <div className="bg-purple-500/10 rounded-xl p-4 border border-purple-500/20">
                  ...
                  <p className="text-[#ab9eb7] leading-relaxed mb-4">{result.summary.overallFortune}</p>
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    <div className="bg-background-dark rounded-lg p-3">
                      <p className="text-gray-400 mb-1">올해의 테마</p>
                      <p className="text-white">{result.summary.yearlyTheme}</p>
                    </div>
                    <div className="bg-background-dark rounded-lg p-3">
                      <p className="text-gray-400 mb-1">행운의 색</p>
                      <p className="text-white">{result.summary.luckyColor}</p>
                    </div>
                    <div className="bg-background-dark rounded-lg p-3">
                      <p className="text-gray-400 mb-1">행운의 숫자</p>
                      <p className="text-white">{result.summary.luckyNumber}</p>
                    </div>
                    <div className="bg-background-dark rounded-lg p-3">
                      <p className="text-gray-400 mb-1">행운의 방위</p>
                      <p className="text-white">{result.summary.luckyDirection}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-indigo-500/10 rounded-xl p-4 border border-indigo-500/20">
                  ...
                  <div className="grid grid-cols-4 gap-2 mb-4">
                    <div className="text-center bg-background-dark rounded-lg p-2">
                      <p className="text-gray-400 text-xs mb-1">년주</p>
                      <p className="text-white font-bold">{result.fourPillars.year}</p>
                    </div>
                    <div className="text-center bg-background-dark rounded-lg p-2">
                      <p className="text-gray-400 text-xs mb-1">월주</p>
                      <p className="text-white font-bold">{result.fourPillars.month}</p>
                    </div>
                    <div className="text-center bg-background-dark rounded-lg p-2">
                      <p className="text-gray-400 text-xs mb-1">일주</p>
                      <p className="text-white font-bold">{result.fourPillars.day}</p>
                    </div>
                    <div className="text-center bg-background-dark rounded-lg p-2">
                      <p className="text-gray-400 text-xs mb-1">시주</p>
                      <p className="text-white font-bold">{result.fourPillars.time}</p>
                    </div>
                  </div>
                  <p className="text-[#ab9eb7] text-sm leading-relaxed">{result.fourPillars.interpretation}</p>
                </div>
                ...
                <div className="bg-amber-500/10 rounded-xl p-4 border border-amber-500/20">
                  ...
                  <p className="text-[#ab9eb7] leading-relaxed">{result.yearlyAdvice}</p>
                </div>
              </div>
            )}
            ...
            {activeTab === 'monthly' && (
              <div className="space-y-4">
                {monthNames.map((month, index) => {
                  ...
                  return (
                    <div key={month} className="bg-background-dark rounded-xl p-4 border border-gray-700">
                      <h3 className="text-white font-semibold mb-3">{month}</h3>
                      <p className="text-[#ab9eb7] text-sm mb-3">{monthData.overall}</p>
                      <div className="space-y-2 text-sm">
                        <div className="flex gap-2">
                          <span className="text-blue-400 min-w-[50px]">직업:</span>
                          <span className="text-gray-300">{monthData.career}</span>
                        </div>
                        <div className="flex gap-2">
                          <span className="text-pink-400 min-w-[50px]">연애:</span>
                          <span className="text-gray-300">{monthData.love}</span>
                        </div>
                        <div className="flex gap-2">
                          <span className="text-yellow-400 min-w-[50px]">재물:</span>
                          <span className="text-gray-300">{monthData.wealth}</span>
                        </div>
                        <div className="flex gap-2">
                          <span className="text-green-400 min-w-[50px]">건강:</span>
                          <span className="text-gray-300">{monthData.health}</span>
                        </div>
                        <div className="mt-2 pt-2 border-t border-gray-600">
                          <span className="text-purple-400">조언: </span>
                          <span className="text-gray-300">{monthData.advice}</span>
                        </div>
                      </div>
                    </div>
                  );
            ...
            {activeTab === 'detailed' && (
              <div className="space-y-4">
                ...
                <div className="bg-blue-500/10 rounded-xl p-4 border border-blue-500/20">
                  ...
                  <p className="text-[#ab9eb7] mb-3">{result.careerFortune.overall}</p>
                  <div className="space-y-2 text-sm">
                    <div>
                ...
                <div className="bg-yellow-500/10 rounded-xl p-4 border border-yellow-500/20">
                  ...
                  <p className="text-[#ab9eb7] mb-3">{result.wealthFortune.overall}</p>
                  <div className="space-y-2 text-sm">
                    <p><span className="text-yellow-400">수입:</span> <span className="text-gray-300">{result.wealthFortune.income}</span></p>
                    <p><span className="text-yellow-400">투자:</span> <span className="text-gray-300">{result.wealthFortune.investment}</span></p>
                ...
                <div className="bg-pink-500/10 rounded-xl p-4 border border-pink-500/20">
                  ...
                  <p className="text-[#ab9eb7] mb-3">{result.loveFortune.overall}</p>
                  <div className="space-y-2 text-sm">
                    <p><span className="text-pink-400">미혼:</span> <span className="text-gray-300">{result.loveFortune.single}</span></p>
                    <p><span className="text-pink-400">기혼/연인:</span> <span className="text-gray-300">{result.loveFortune.coupled}</span></p>
                ...
                <div className="bg-green-500/10 rounded-xl p-4 border border-green-500/20">
                  ...
                  <p className="text-[#ab9eb7] mb-3">{result.healthFortune.overall}</p>
                  <div className="space-y-2 text-sm">
                    <div>
                ...
                <div className="bg-cyan-500/10 rounded-xl p-4 border border-cyan-500/20">
                  ...
                  <div className="space-y-2 text-sm">
                    <p><span className="text-cyan-400">가족:</span> <span className="text-gray-300">{result.relationshipFortune.family}</span></p>
                    <p><span className="text-cyan-400">친구:</span> <span className="text-gray-300">{result.relationshipFortune.friends}</span></p>
                    <p><span className="text-cyan-400">직장:</span> <span className="text-gray-300">{result.relationshipFortune.colleagues}</span></p>
                ...
                <div className="bg-violet-500/10 rounded-xl p-4 border border-violet-500/20">
                  ...
                  <div className="space-y-2 text-sm">
                    <p><span className="text-violet-400">명상:</span> <span className="text-gray-300">{result.spiritualGuidance.meditation}</span></p>
                    <p><span className="text-violet-400">의식:</span> <span className="text-gray-300">{result.spiritualGuidance.rituals}</span></p>
                    <div>
