                ...
                <div
                  ...
                  className={`relative p-5 rounded-2xl border-2 cursor-pointer transition ${
                    selectedPackage === pkg.id
                      ? 'border-pink-400 bg-pink-50/80 shadow-lg shadow-pink-200/50'
                      : 'border-pink-100/50 bg-white/60 hover:border-pink-300 hover:bg-white/80'
                  }`}
                >
                  {/* 인기 뱃지 */}
                  {pkg.popular && (
          ...
          <div className="glass-panel rounded-2xl p-6">
            ...
            <div className="space-y-3">
              {purchaseHistory.map((history) => (
                <div key={history.id} className="bg-gradient-to-br from-white to-pink-50/50 rounded-xl p-4 border border-pink-100/50 shadow-sm">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-xs text-muted-foreground bg-pink-100/60 px-2 py-1 rounded">
                      {history.method}
                    </span>
                  </div>
