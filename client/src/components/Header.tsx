        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative" ref={languageDropdownRef}>
            ...
            {languageDropdownOpen && (
              <div className="absolute right-0 mt-2 w-32 bg-sidebar-dark border border-border rounded-lg shadow-lg overflow-hidden z-50">
                <button
          ...
          {isLoggedIn ? (
            <>
              ...
              <div className="relative" ref={profileDropdownRef}>
                ...
                {/* 프로필 드롭다운 메뉴 */}
                {profileDropdownOpen && (
                  <div className="absolute right-0 mt-2 w-72 bg-sidebar-dark border border-border rounded-lg shadow-lg overflow-hidden z-50">
                    {/* 사용자 정보 */}
